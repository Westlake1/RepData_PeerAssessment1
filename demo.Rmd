...
#knitr::knit2html("demo.Rmd",  "demo.md")

#library(knitr)
#opts_knit$set(base.dir = 'RepData_Assessm#ent1') # Change the base dir where to #save figures
#knit2html("./RepData_Assessment1/demo.Rmd", "./RepData_Assessment1/demo.html")
#knit2html("./demo.Rmd", )
